...
(function() {
  $(function() {
    var randBetween, spinAllReels, spinSingleReel;
    ...
    spinSingleReel = function(reelNumber, relativeTargetOffset) {
      ...
      roundedPosition = Math.ceil(currentPosition / 1374) * 1374;
      targetOffset = roundedPosition + (randBetween(4, 7) * 1374) + (relativeTargetOffset * 76.3);
    ...
    return $("[data-type=submit-bet]").click(function() {
      return $.ajax({
        type: "POST",
        url: "/games",
        data: {
        ...
        success: function(jsonObject) {
          return spinAllReels(jsonObject.data.rotation_offsets);
        },
